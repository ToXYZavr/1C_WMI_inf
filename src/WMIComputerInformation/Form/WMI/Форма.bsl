	// ServicesSet = Locator.ConnectServer("NameNet", "NameSpace", "User", "Password");
 	// Доступ по сети к другой машине, где:
 	//   NameNet - сетевое имя
 	//   NameSpace - имя пути для WMI, поумолчанию "root\cimv2" можно не указывать
 	//   User - имя пользователя с правами администратора
 	//   Password - пароль

&НаКлиенте
Перем Locator, ServicesSet Экспорт ;
